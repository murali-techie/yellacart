    ...
    public function collection(Collection $rows)
    {
        ...
        if ($canImport) {
            foreach ($rows as $row) {
                ...
                $categoryId = Category::whereName($row['category'])->first()->id;
                ...
                $productId->discount_start_date = $row['discount_start_date'];
                $productId->discount_end_date = $row['discount_end_date'];
                $productId->discount = $row['discount'];
                $productId->discount_type = $row['discount_type'];

                    ...
                    @if (Auth::check() && get_setting('wallet_system') == 1)
                            <div class="text-center py-2">
                                <div style="width: 150px;" class="pt-2 mx-auto">
                                    <img class="img-fluid" src="{{ static_asset('assets/img/cards/yellawallet.png') }}" />
                                </div>
                                <div class="h6 mb-3">
                        ...
                        <div class="mb-4">
                            <div>
                                <h5 style="border-bottom: solid 1px #ebedf2" class="pb-2 mb-2">
                            ...
                            @if(get_setting('razorpay') == 1)
                                <div class="py-2">
                                    <label>
                                        <input value="upi" class="online_payment" type="radio"
                                               name="payment_option" checked>
                                               <span style="display: inline-block; width: 100px; margin-left: 8px;"><img class="img-fluid" src="{{ static_asset('assets/img/cards/upi.jpg') }}" /></span>
                                ...
                                <div class="py-2">
                                    <label>
                                        <input value="wallet" class="online_payment" type="radio"
                                               name="payment_option">
                                               <span style="display: inline-block; width: 100px; margin-left: 8px;"><img class="img-fluid" src="{{ static_asset('assets/img/cards/digital-wallets.jpg') }}" /></span>
                                        <span class="font-weight-bold pl-2">
                                        {{ translate('Digital Wallet')}}
                                        </span>
                                    </label>
                                </div>
                                <div class="py-2">
                                    <label>
                                        <input value="card" class="online_payment" type="radio"
                                               name="payment_option">
                                               <span style="display: inline-block; width: 100px; margin-left: 8px;"><img class="img-fluid" src="{{ static_asset('assets/img/cards/credit-cards.jpg') }}" /></span>
                                        <span class="font-weight-bold pl-2">
                                ...
                                <div class="py-2">
                                    <label>
                                        <input value="netbanking" class="online_payment" type="radio"
                                               name="payment_option">
                                               <span style="display: inline-block; width: 50px; margin-left: 8px;"><img class="img-fluid" src="{{ static_asset('assets/img/cards/netbanking.png') }}" /></span>
                                        <span class="font-weight-bold pl-2">
                                        {{ translate('Net Banking')}}
                                        </span>
                                    </label>
                                </div>
                            @endif
                                    ...
                                    <div class="py-2">
                                        <label>
                                            <input value="cash_on_delivery" class="online_payment"
                                                   ...
                                                   <span style="display: inline-block; width: 50px; margin-left: 8px;"><img class="img-fluid" src="{{ static_asset('assets/img/cards/cod.png') }}" /></span>
                                            <span class="font-weight-bold pl-2">
                                        ...
                                        <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="card" class="online_payment" type="radio"
                                                               name="payment_option" checked>
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/credit-cards.jpg')}}"
                                                             class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('Credit / Debit Card')}}</span>
                                                        </span>
                                                    </span>
                                                    </label>
                                                </div>
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            <input value="netbanking" class="online_payment" type="radio"
                                                                   name="payment_option">
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/netbanking.jpg')}}"
                                                             class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('Netbanking')}}</span>
                                                        </span>
                                                    </span>
                                                        </label>
                                                    </div>
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            <input value="wallet" class="online_payment" type="radio"
                                                                   name="payment_option">
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/digital-wallets.jpg')}}"
                                                             class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('Digital Wallet')}}</span>
                                                        </span>
                                                    </span>
                                                        </label>
                                                    </div>
                                                    <div class="col-6 col-md-4">
                                                        <label class="aiz-megabox d-block mb-3">
                                                            <input value="upi" class="online_payment" type="radio"
                                                                   name="payment_option">
                                                            <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/upi.jpg')}}"
                                                             class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var data = {
                'carts': @json($carts),
                'payment_option': $paymentOption.val(),
                'shipping_info': @json($shipping_info)
            };
            loadCartSummary(data);

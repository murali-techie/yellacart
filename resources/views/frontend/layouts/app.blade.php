...
<head>
    ...
    <meta name="google-site-verification" content="Kjgme3DhYO0qx8U0KhG_thm23ma5-iK5MwVpXBDf25o" />
...
s.parentNode.insertBefore(t,s)}(window, document,'script',
'https://connect.facebook.net/en_US/fbevents.js');
fbq('init', '649739649340334');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=649739649340334&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
...
<body>
    ...
    <!-- SCRIPTS -->
    <script src="{{ static_asset('assets/js/axios.js') }}"></script>
            ...
            if(checkAddToCartValidity()) {
                ...
                $.ajax({
                    ...
                    //   $('#addToCart-modal-body').html(data.modal_view);
                       AIZ.plugins.notify('success', "{{ translate('Item has been added to your cart') }}");
                       AIZ.extra.plusMinus();
                       updateNavCart(data.nav_cart_view,data.cart_count);
                    }
                });

              ...
              <form class="" action="{{ route('wallet.recharge') }}" method="post">
                  ...
                  <div class="modal-body gry-bg px-3 pt-3">
                      <div class="row mb-3">
                          ...
                          <div class="col-md-8">
                              <!-- <input type="number" lang="en" class="form-control mb-3" name="amount" hidden placeholder="{{ translate('Amount')}}" required> -->
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="500" name="amount" hidden id="btn-check-outlined" checked autocomplete="off" >
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-outlined">500</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="1000" name="amount" hidden id="btn-check-2-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-2-outlined">1000</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="1500" name="amount" hidden id="btn-check-3-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-3-outlined">1500 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="2000" name="amount" hidden id="btn-check-4-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-4-outlined">2000 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="2500" name="amount" hidden id="btn-check-5-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-5-outlined">2500 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="3000" name="amount" hidden id="btn-check-6-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-6-outlined">3500 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="4000" name="amount" hidden id="btn-check-7-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-7-outlined">4000 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="4500" name="amount" hidden id="btn-check-8-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-8-outlined">4500 </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="btn-check" type="radio" value="5000" name="amount" hidden id="btn-check-9-outlined" autocomplete="off">
                                    <label class="btn btn-outline-dark btn-sm rounded-pill" for="btn-check-9-outlined">5000 </label>
                                </div>
                          </div>
                      </div>
                      <div class="row">

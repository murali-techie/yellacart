...
@section('content')
    {{-- Categories , Sliders . Today's deal --}}
     ...
     @if (get_setting('home_slider_images') != null)
                    ...
                    @if (count($featured_categories) > 0)
                        <ul class="list-unstyled mb-0 row gutters-5 d-none">
        ...
        <div class="container">
            <div class="row gutters-10">
                ...
                @foreach ($banner_1_imags as $key => $value)
                    <div class="col-xl col-md-3" style="height: 400px;overflow: hidden;">
                        <div class="mb-3 mb-lg-0">
                            <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}" class="text-reset">
                                <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset($banner_1_imags[$key]) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100" style="height: 100%;object-fit: cover;">
                            </a>
                        </div>
                    </div>
                @endforeach
            ...
            <!--        @foreach ($banner_1_imags as $key => $value)-->
            <!--        @if ($key > 0 && $key < 3)-->
            <!--            <div class="mb-3 mb-lg-0" style="height: 203px;overflow: hidden;padding: 5px;padding-top:0px">-->
            <!--                <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}" class="text-reset">-->
            <!--                    <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset($banner_1_imags[$key]) }}" alt="{{ env('APP_NAME') }} promo" class="img-fluid lazyload w-100" style="height: 100%;object-fit: cover;">-->
            <!--                </a>-->
            <!--            </div>-->
    ...
    <div id="section_best_sellers d-none">

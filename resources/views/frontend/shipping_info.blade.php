                                        ...
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    <div>
                                                        <span class="opacity-60">{{ translate('Title') }}:</span>
                                                        <span class="fw-600 ml-2">{{ $address->address_type ? ucfirst($address->address_type) : 'Home' }}</span>
                                                    </div>
                                                    <div>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="address_type" required>

                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    @auth
                        ...
                        @else
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0 dropdown d-none">
        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                    ...
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        <div class="d-none d-xl-block align-self-stretch category-menu-icon-box ml-auto mr-0">
                            <div class="h-100 d-flex align-items-center" id="category-menu-icon">
                                <div class="dropdown-toggle navbar-light h-40px  pl-5  c-pointer" style="font-family:'Open Sans';font-weight:700">
                                    All Categories
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-lg-none ml-auto mr-0">
                    ...
                    <!--<ul class="list-inline mb-0 h-100 justify-content-end align-items-center d-none d-xl-block">-->
                    ...
                    <!--            <a href="{{ route('products.category', $category->slug) }}" class="text-reset d-inline-block opacity-60">{{ $category->getTranslation('name') }}</a>-->
                    <!--        </li>-->
                    <!--        @endif-->
                    <!--  @endforeach-->
                    <!--</ul>-->

                <div class=" front-header-search d-flex align-items-center bg-white  ml-auto">
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center ml-4 newlogin">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg py-0">
                                    ...
                                    <div class=" c-scrollbar-light overflow-auto " style="max-height:300px;">
                                        <ul class="list-group list-group-flush" >
                                            ...
                                            @if(isAdmin())
                                                <li class="list-group-item">
                                                    <a href="{{ route('admin.dashboard') }}" class="">{{ translate('My Panel')}}</a>
                                                </li>
                                            @else
                                            
                            
                            <li class="list-group-item">
                                <a href="{{ route('dashboard') }}" class=""><img src="{{ static_asset('assets/img/icons8-account-48.png') }}" style="width: 18px;height: 18px;margin-right: 5px;">{{ translate('My Account')}}</a>
                            </li>
                             
                            <li class="list-group-item">
                                <a href="{{ route('purchase_history.index') }}" class=""><img src="{{ static_asset('assets/img/icons8-purchase-order-24.png') }}" style="width: 18px;height: 18px;margin-right: 5px;">{{ translate('My Orders')}}</a>
                            </li>
                             <li class="list-group-item">
                                <a href="{{ route('wallet.index') }}" class=""><img src="{{ static_asset('assets/img/wallet.png') }}" style="width: 18px;height: 18px;margin-right: 5px;">{{ translate('Yella Wallet')}}</a>
                            </li>
                            
                        @endif
                        <li class="list-group-item">
                            <a href="{{ route('logout') }}" class=""><img src="{{ static_asset('assets/img/icons8-logout-58.png') }}" style="width: 18px;height: 18px;margin-right: 5px;">{{ translate('Logout')}}</a>
                        </li>
                    @else
                        <li class="list-group-item">
                        ...
                        <li class="list-group-item">
                            <a href="{{ route('user.registration') }}" class="">{{ translate('Registration')}}</a>
                        </li>
                   ...
                   <?php /* @auth
                    ...
                    @else
                        <li class="list-inline-item mr-2 border-right border-left-0 pr-2 pl-0">
                            <a href="{{ route('user.login') }}" class="text-reset d-inline-block opacity-60">{{ translate('Login')}}</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="{{ route('user.registration') }}" class="text-reset d-inline-block opacity-60">{{ translate('Registration')}}</a>
                ...
                <div class="d-none d-lg-block   ml-3 mr-0" data-hover="dropdown" style="border: 1px solid #ededed;padding: 2px 15px 2px 10px;border-radius: 3px;">

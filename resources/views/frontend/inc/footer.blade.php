...
<div class="footer1-widgets d-none">
        ...
        <div class="container">
			...
			<div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-center">
					      ...
					      <img class="img-responsive absll" src="https://yellacart.com/uploads/bg_no-removebg-preview.png">
        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div class="d-inline-block d-md-block mb-4 rss">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            @csrf
                            <div class="form-group mb-0">
                                <input type="email" class="form-control" placeholder="{{ translate('Your Email Address') }}" name="email" required style="border-radius: 0;">
                            </div>
                     ...
                     <ul class="list-inline my-3 my-md-0 social colored text-left mt-4">
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-13 text-uppercase fw-600  border-gray-900 pb-2 mb-4">

                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Length" name="length" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Breadth" name="breadth" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Height" name="height" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Weight" name="weight" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">

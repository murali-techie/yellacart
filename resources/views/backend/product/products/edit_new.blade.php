                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Length" name="length" value="{{ $product->stocks->first()->length }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Breadth" name="breadth" value="{{ $product->stocks->first()->breadth }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Height" name="height" value="{{ $product->stocks->first()->height }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Product Weight" name="weight" value="{{ $product->stocks->first()->weight }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">

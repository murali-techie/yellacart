...
// update shipping price for cart
Route::post('checkout/payment_select/load_cart_summary', 'CartController@updateShippingCost')->name(
    'cart.shipping.update'
);

// check pincode availability
Route::post('pincode/verify', 'PincodeController@verify')->name('pincode.verify');